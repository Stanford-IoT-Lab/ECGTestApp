...
public class BluetoothLeService extends Service{
    ...
    private void broadcastUpdate(final String action) {
        Log.e("BluetoothLeService","broadcastUpdate action: "+ action);
    ...
    private void broadcastUpdate(final String action,
        ...
        Log.e("BluetoothLeService","broadcastUpdate action2: "+ action);
        final Intent intent = new Intent(action);

        if (UUID_LISTED_DEVICE_INDICATE.equals(characteristic.getUuid())) {
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        if(UUID_LISTED_DEVICE_INDICATE.equals(characteristic.getUuid())){
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(
                    UUID.fromString(ECGAttributes.CLIENT_CHARACTERISTIC_CONFIG));
    ...
    public void onCreate() {
        super.onCreate();
        Toast.makeText(this, "BLE Serivce created", Toast.LENGTH_SHORT).show();
